...
class AdministratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post administrators_url, params: { administrator: { admission: @administrator.admission, departure: @administrator.departure, lastname: @administrator.lastname, name: @administrator.name, residential_id: @administrator.residential_id } }
    end
  ...
  test "should update administrator" do
    patch administrator_url(@administrator), params: { administrator: { admission: @administrator.admission, departure: @administrator.departure, lastname: @administrator.lastname, name: @administrator.name, residential_id: @administrator.residential_id } }
