...
class MachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post machines_url, params: { machine: { accumulated: @machine.accumulated, historical_id: @machine.historical_id, id_user: @machine.id_user, inserted: @machine.inserted, month: @machine.month } }
    end
  ...
  test "should update machine" do
    patch machine_url(@machine), params: { machine: { accumulated: @machine.accumulated, historical_id: @machine.historical_id, id_user: @machine.id_user, inserted: @machine.inserted, month: @machine.month } }
